...
const Hero = styled.div`
  ${tw('w-full xl:w-2/3 border-solid border-purple rounded-lg p-6')};
`;
    ...
    <Divider fill="#23262b" speed={0.2} offset={0}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <Subtitle>The big brown fox jumps over the log.</Subtitle>
        </Hero>
        <GoDown>
        <SVG icon="arrowUp" className={hidden} width={8} fill={colors["purple-light"]}/>
        </GoDown>
      </Content>
      <DividerMiddle
